...
hi popiceALAccentRed ctermfg=203 guifg=#e27878
...
if has('nvim')
  ...
  let g:terminal_color_4 = '#6db3e2'
  let g:terminal_color_5 = '#c389c9'
  let g:terminal_color_6 = '#91d2e0'
  ...
  let g:terminal_color_13 = '#b894ce'
  let g:terminal_color_14 = '#95c4ce'
  let g:terminal_color_15 = '#d2d4de'
else
  let g:terminal_ansi_colors = ['#1e2132', '#e27878', '#b4be82', '#e2a478', '#6db3e2', '#c389c9', '#91d2e0', '#c6c8d1', '#6b7089', '#e98989', '#c0ca8e', '#e9b189', '#91acd1', '#b894ce', '#95c4ce', '#d2d4de']
endif
